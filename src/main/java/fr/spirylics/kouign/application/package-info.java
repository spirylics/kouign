 ...
 * <p>
 * This layer acts as the entry point for external requests and exposes
 * domain services through REST endpoints. It directly exposes domain
 * entities without DTOs, following the pragmatic hexagonal architecture
 * approach.
 * <p>
